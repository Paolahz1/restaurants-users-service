...
import com.foodcourt.users_service.domain.usecase.CreateClientUseCase;
...
public class ClientBeanConfiguration {
    ...
    private final IUserValidationService validationService;
     ...
     @Bean
    public ICreateClientServicePort createClientServicePort(){
         return new CreateClientUseCase(userPersistencePort,passwordEncoderPort, validationService );
     }
}
